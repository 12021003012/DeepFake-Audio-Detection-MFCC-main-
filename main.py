...
def analyze_audio(input_audio_path):
    ...
    if not os.path.exists(input_audio_path):
        return "Error: The specified file does not exist.", None
    elif not input_audio_path.lower().endswith(".wav"):
        return "Error: The specified file is not a .wav file.", None
    ...
    if mfcc_features is not None:
        ...
        confidence = svm_classifier.predict_proba(mfcc_features_scaled)[0][prediction[0]]

        if prediction[0] == 0:
            return "The input audio is classified as genuine.", confidence
        else:
            return "The input audio is classified as deepfake.", confidence
    else:
        return "Error: Unable to process the input audio.", None
def main():
    genuine_dir = r"C:\Users\sengu\Downloads\DeepFake-Audio-Detection-MFCC-main (1)\DeepFake-Audio-Detection-MFCC-main\real_audio"
    deepfake_dir = r"C:\Users\sengu\Downloads\DeepFake-Audio-Detection-MFCC-main (1)\DeepFake-Audio-Detection-MFCC-main\deepfake_audio"
